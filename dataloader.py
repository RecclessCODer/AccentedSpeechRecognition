...
class MultiDataset(Dataset):
    ...
    def __init__(self, manifest, labels, _accent_dict, manifest_separator=',',
        ...
        super(MultiDataset, self).__init__(), 'sada'

        self.config = {'use_mfcc_in': use_mfcc_in, 'use_ivectors_in': use_ivectors_in,
                       'use_embeddings_in': use_embeddings_in, 'embedding_size': embedding_size,
                       'use_transcripts_out': use_transcripts_out, 'use_accents_out': use_accents_out}
