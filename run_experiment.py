...
def run_experiment(_exp_name,
    ...
    # Tools to log values
    results_dict = {'train_loss': [], 'train_loss_text': [], 'train_loss_accent': [], 'test_loss': [],
                    'test_loss_text': [], 'test_loss_accent': [], 'test_wer': [], 'test_accent_acc': []}
...
if __name__ == '__main__':
    ...
    for conf in confs.patch_config(PATCH_PATH):
        ...
        try:
            ...
            print(f'Error occurred in run {exp_name}:', e)
