...
_batch_size = 1
_num_workers = 4
model_path = './saved_models/TrainMulti_TRAIN__in_mfcc__out_transcripts_accents-mix0.9' \
             '-CE__nblyrs-head-4-speech-1-accent-1__bnf-256__25-02-2021_00h36m38.pth'
